...
void intro()
{
	...
	gotoXY(20,11); printf("KRITAGYA PAINULY");
	gotoXY(20,13); printf("https://github.com/KritagyaPainuly");
	gotoXY(20,15); printf("https://www.linkedin.com/in/kritagya-painuly-405024217/");
